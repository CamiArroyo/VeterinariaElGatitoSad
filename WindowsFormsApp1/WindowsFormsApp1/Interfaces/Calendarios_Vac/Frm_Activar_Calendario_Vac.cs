...
{
    public partial class Frm_Activar_Calendario_Vac : Form
    {
        private Calendario_Vacunacion calendario;
        private CalendariosVacServicio calendario_servicio;

        public Frm_Activar_Calendario_Vac(long id)
        {
        ...
        private void DarAltaCalendario()
        {
            calendario_servicio.DarAltaCalendario(calendario);

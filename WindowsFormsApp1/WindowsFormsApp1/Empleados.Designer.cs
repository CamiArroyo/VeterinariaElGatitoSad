...
namespace WindowsFormsApp1.EmpleadosTableAdapters {
    ...
    public partial class EMPLEADOSTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[EMPLEADOS] SET [nombre] = @nombre WHERE (([id_empleado] = @Original" +
                "_id_empleado) AND ((@IsNull_nombre = 1 AND [nombre] IS NULL) OR ([nombre] = @Ori" +
                "ginal_nombre)));\r\nSELECT id_empleado, nombre FROM EMPLEADOS WHERE (id_empleado =" +
                " @id_empleado)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT id_empleado, nombre FROM dbo.EMPLEADOS WHERE estado=\'Activo\'";
        ...
        public virtual int Fill(Empleados.EMPLEADOSDataTable dataTable) {
        ...
        public virtual Empleados.EMPLEADOSDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Empleados.EMPLEADOSDataTable dataTable = new Empleados.EMPLEADOSDataTable();
        ...
        public virtual int EmpleadosActivos(Empleados.EMPLEADOSDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Empleados.EMPLEADOSDataTable dataTable) {
        ...
        public virtual int Update(string nombre, int Original_id_empleado, string Original_nombre, int id_empleado) {
            if ((nombre == null)) {
        ...
        public virtual int Update(string nombre, int Original_id_empleado, string Original_nombre) {
            return this.Update(nombre, Original_id_empleado, Original_nombre, Original_id_empleado);
        }
    }
